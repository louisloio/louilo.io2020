    ...
    if(multiple){
        for(var i in answers){
            if(answers.hasOwnProperty(i)){
                var option = $('<div class="option animated3 fadeIn">'+answers[i].text+'</div>')
        ...
        */
        ...
        if(inputs.length) {
            ...
            switch(parameters.typeInputUi) {
                case 'input':
                    inputForm = $('<form action="" method="POST" enctype="multipart/form-data"  id="' + parameters.formIdName + '" class="convFormDynamic"><div class="options dragscroll"></div><input id="' + parameters.inputIdName + '" type="text" placeholder="'+ parameters.placeHolder +'" class="userInputDynamic"></><button type="submit" value="Send email" class="submit"><i class="material-icons">chat</i></button><span class="clear"></span></form>');
                    break;
                case 'textarea':
                    inputForm = $('<form action="" method="POST" enctype="multipart/form-data" id="' + parameters.formIdName + '" class="convFormDynamic"><div class="options dragscroll"></div><textarea id="' + parameters.inputIdName + '" rows="1" placeholder="'+ parameters.placeHolder +'" class="userInputDynamic"></textarea><button type="submit" value="Send email" class="submit"><i class="material-icons">chat</i></button><span class="clear"></span></form>');
                    break;
                default :
